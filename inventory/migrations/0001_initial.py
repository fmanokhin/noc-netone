# Generated by Django 2.0.7 on 2018-10-15 12:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upstreampop', models.ManyToManyField(blank=True, to='inventory.Pop')),
            ],
        ),
        migrations.AddField(
            model_name='pop',
            name='downstreampop',
            field=models.ManyToManyField(blank=True, to='inventory.PopConnection'),
        ),
        migrations.AddField(
            model_name='pop',
            name='upstream',
